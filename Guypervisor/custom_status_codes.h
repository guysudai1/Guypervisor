...
#define STATUS_FAILED_VMLAUNCH NT_ERROR(BASE_ERROR + 0x14)

#define STATUS_FAILED_VMREAD NT_ERROR(BASE_ERROR + 0x15)
#define STATUS_FAILED_VMWRITE NT_ERROR(BASE_ERROR + 0x16)

/*
 * Pointer errors
 */
#define STATUS_NULLPTR_ERROR NT_ERROR(BASE_ERROR + 0x30)
